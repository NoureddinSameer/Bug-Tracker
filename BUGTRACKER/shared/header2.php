...
<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="../welcome.php">Dashboard </a>

    <?php if (isset($_SESSION['admin'])) : ?>
        <a class="nav-link nav-profile d-flex align-items-center pe-0" href="../welcome.php" data-bs-toggle="dropdown">
